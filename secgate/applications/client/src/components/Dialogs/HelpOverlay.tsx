...
import { ExternalLink, Header, Spacer, Txt } from '@secgate/ui-styles';
	...
	<DialogEx css={layoutStyle} {...props}>
		<section cy-test="about-modal" css={{ padding: '1.5rem 3rem 2rem' }}>
			<Header cy-test="about-modal-header" large css={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
				<Logo cy-test="secgate-logo" css={{ height: '4rem', marginLeft: -16 }} />
				<Spacer />
				<Txt>
					SecGate{' '}
			...
			<Txt cy-test="about-modal-description" tagName="p">
				SecGate is a red team C2 log visualization tool developed by <ExternalLink regular {...pnnlLink} /> for the{' '}
...
const githubLink: LinkInfo = {
	href: 'https://github.com/khulnasoft/securitylab',
