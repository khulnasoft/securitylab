import { CarbonIcon, VirtualizedList, semanticIcons } from '@secgate/client/components';
import type { PresentationItemModel, SortTypeCommentsList } from '@secgate/client/store';
import {
	routes,
...
import { CoreTokens, FlexSplitter, Txt } from '@secgate/ui-styles';
import { useQuery } from '@tanstack/react-query';
import { observer } from 'mobx-react-lite';
import { StarFilled16, Hashtag16, Playlist16, User16 } from '@carbon/icons-react';
import type { ComponentProps } from 'react';
import { useCallback, useMemo } from 'react';
import { CampaignViews, Tabs } from '@secgate/client/types';
