...
import { CarbonIcon, ScrollBox } from '@secgate/client/components';
...
import { InfoType, Tabs } from '@secgate/client/types/explore';
import { TabsStyled, CoreTokens, Flex, AdvancedTokens } from '@secgate/ui-styles';
