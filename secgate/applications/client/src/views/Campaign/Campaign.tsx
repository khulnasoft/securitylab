...
import { AuthCheck, CarbonIcon, DragResize, ErrorFallback, NavBar } from '@secgate/client/components';
import {
	beaconQuery,
	...
	serverQuery,
	useStore,
} from '@secgate/client/store';
import { SecGateRoutes } from '@secgate/client/store/routing/router';
import { Graph, RawLogsDialog, Timeline } from '@secgate/client/views';
import type { TxtProps } from '@secgate/ui-styles';
import { CoreTokens, CardStyled, UtilityStyles, Spacer, Txt } from '@secgate/ui-styles';
					...
					fixedContent={({ collapseFixed }) => (
						<div css={infoWrapperStyles}>
							...
							<Suspense fallback={<Spinner />}>
								<Routes>
									<Route path={`${SecGateRoutes.CAMPAIGN_EXPLORE}/*`} element={<Explore css={routeStyle} />} />
									<Route
										path={`${SecGateRoutes.CAMPAIGN_PRESENTATION}/*`}
										element={<Presentation css={routeStyle} />}
									/>
								</Routes>
							</Suspense>
							{/* <Search /> */}
