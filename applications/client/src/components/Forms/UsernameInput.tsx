...
import { CarbonIcon, createState, escapeRegExpChars } from '@secgate/client/components';
import type { GlobalOperatorModel } from '@secgate/client/store';
import { useStore } from '@secgate/client/store';
import { UtilityStyles, Txt, CoreTokens } from '@secgate/ui-styles';
