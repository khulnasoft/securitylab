import type { RouteParams } from '@secgate/client/types/routing';
import { CampaignViews, Views } from '@secgate/client/types/routing';
 ...
 */
export const routes = {
	[Views.CAMPAIGN]: SecGateRoutes.CAMPAIGN,
	[Views.CAMPAIGNS_LIST]: SecGateRoutes.CAMPAIGNS_LIST,
	[CampaignViews.EXPLORE]: `${SecGateRoutes.CAMPAIGN}/:view(${CampaignViews.EXPLORE})/${currentItemParams}/:tab(${tabs})?/${activeItemParams}`,
	[CampaignViews.PRESENTATION]: `${SecGateRoutes.CAMPAIGN}/:view(${CampaignViews.PRESENTATION})/:presentation?/:slide?/${activeItemParams}`,
	[CampaignViews.SEARCH]: `${SecGateRoutes.CAMPAIGN}/:view(${CampaignViews.SEARCH})`,
};
...
@model('Router')
export class Router extends ExtendedModel(SecGateModel, {
