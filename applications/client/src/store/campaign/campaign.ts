...
import { nodeColor, sortOptions } from '@secgate/client/views';
import type { Graph as BSGraph } from '@secgate/graph';
import { SecGateGraph } from '@secgate/graph';
...
export class CampaignStore extends ExtendedModel(() => ({
	...
	@observable graph: SecGateGraph | undefined;
