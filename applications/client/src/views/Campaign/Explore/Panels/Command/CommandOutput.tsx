...
import type { MitreAttackId } from '@secgate/client/components';
import { CarbonIcon, MitreAttack } from '@secgate/client/components';
...
import { ScreenShotCommand } from '@secgate/client/views';
import { Txt, CoreTokens, UtilityStyles, Flex, Spacer } from '@secgate/ui-styles';
