...
import type { HostModel, RootStoreBase } from '@secgate/client/store';
import { hostQuery, useStore } from '@secgate/client/store';
import { InfoType } from '@secgate/client/types';
import { Flex, Txt } from '@secgate/ui-styles';
