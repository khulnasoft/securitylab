...
import { ScrollBox, ScrollChild } from '@secgate/client/components';
import {
...
import { PresentationItem, PresentationNavBar, PresentationTopicItem } from '@secgate/client/views';
import { Header, CoreTokens } from '@secgate/ui-styles';
...
const Presentation = observer<PresentationProps>(({ ...props }) => {
	...
	return (
		...
		>
			<Routes>
				<Route
					path={`${SecGateRoutes.CAMPAIGN_PRESENTATION_SELECTED}/*`}
					element={
						<>
							<PresentationNavBar />
							<StyledScrollBox>
