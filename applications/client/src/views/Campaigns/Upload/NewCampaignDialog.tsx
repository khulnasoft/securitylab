...
import { DialogEx, ErrorFallback, createState } from '@secgate/client/components';
import { SecGateDbUploadForm } from '@secgate/client/views';
import { CoreTokens, ExternalLink, Header, Txt } from '@secgate/ui-styles';
			...
			<ErrorBoundary FallbackComponent={ErrorFallback}>
				<div>
					...
					{state.currentUploadOptionValue === SOURCE_UNSET ? (
						...
						<SecGateDbUploadForm onClose={props.onClose} />
