import type { BeaconLineType, LogType, MitreTechniques, ServerType } from '@secgate/models';
import {
	Annotation,
	Beacon,
	BeaconMeta,
...
import type { ParserInfo, ParserOutput } from '@secgate/parser-core';
import {
	createLoggerInstance,
	ParserMessageTypes,
	getParserPrefixAndMessage,
	escapeFilePath,
} from '@secgate/parser-core';
